<template>
    <span class="inline-flex">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="spinMe bi bi-hypnotize"
            viewBox="0 0 16 16">
            <path
        ...
        &nbsp;
        <h1 class="font-bold text-4xl text-center">markGPT</h1>
    </span>
</template>
<style scoped>
@keyframes spin {
