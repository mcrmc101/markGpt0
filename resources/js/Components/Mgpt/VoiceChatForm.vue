    ...
    if (navigator.mediaDevices.getUserMedia) {
        ...
        let onSuccess = function (stream) {
            ...
            mediaRecorder.value.onstop = function (e) {
                ...
                speechSynthesis.speak(new SpeechSynthesisUtterance('Working'));
                ...
                axios.post(route('chat.speech'), formData, {
                    ...
                    .then((res) => {
                        ...
                        speechSynthesis.speak(new SpeechSynthesisUtterance(res.data.message));
...
<template>
    ...
    <div class="flex flex-col items-center justify-center w-full my-4">
        <template v-if="recordVoice">
            ...
            <button class="btn btn-success btn-lg" v-show="!isRecording" ref="recordButton">
