...
-->
        <img src="/img/catprofile.jpg" alt="markGPT cat" class="mx-auto rounded-full shadow dark:invert spinMe" />
    ...
    <form @submit.prevent="submitForm()">
        ...
        <button class="w-full my-2 font-extrabold btn btn-success" type="submit">
