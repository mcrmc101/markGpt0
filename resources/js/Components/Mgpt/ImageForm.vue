...
<template>
    ...
    <form @submit.prevent="submitForm()">
        ...
        <select class="w-full mb-2 select select-bordered" v-model="selectedSize">
            <option value="1024x1024">Square</option>
            <option value="1024x1792">Portrait</option>
            <option value="1792x1024">Landscape</option>
        </select>
        <select class="w-full mb-2 select select-bordered" v-model="selectedQuality">
            <option value="standard">Standard</option>
            <option value="hd">HD</option>
        </select>
        <button class="w-full mb-2 font-extrabold btn btn-success" type="submit">
